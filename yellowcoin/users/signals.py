...
reset_password = create_email_signal(['ip', 'location', 'key'], 'Reset Password Request', 'login', 'users/email/reset_password.html', 'Password reset request from {{ location }}. Check your email for more details. Contact us at abuse@yellowco.in if you did not expect this.')
