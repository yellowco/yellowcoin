...
login = create_email_signal(['ip', 'location'], 'Successful Authorization', 'login', 'users/email/login.html', 'Yellowcoin login authorized from {{ location }}. Contact us at help@yellowco.in if you did not expect this.')
login_failed = create_email_signal(['ip', 'location'], 'Unsuccessful Authorization', 'login_failed', 'users/email/login_failed.html', 'Yellowcoin login failed from {{ location }}. Contact us at help@yellowco.in if you did not expect this.')
...
update_password = create_email_signal([], 'Password Changed', 'update_password', 'users/email/update_password.html', 'Your Yellowcoin password has been changed. Contact us at help@yellowco.in if you did not expect this.', force_email=True)
create_bank_account = create_email_signal(['bank_account'], 'Bank Account Added', 'create_bank_account', 'users/email/create_bank_account.html', 'A bank account was added to your Yellowcoin account. Contact us at help@yellowco.in if you did not expect this.')
create_crypto_account = create_email_signal(['crypto_account'], 'Crypto Account Added', 'create_crypto_account', 'users/email/create_crypto_account.html', 'A crypto account was added to your Yellowcoin account. Contact us at help@yellowco.in if you did not expect this.')
